...
public class ModelActivity extends AppCompatActivity implements RecognitionListener {
	String serial = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(ModelActivity.this);
	...
	public void onResults(Bundle results) {
		...
		//SerialEditText.setText(Arrays.toString(nbest.toArray(new String[nbest.size()])));
		...
		serial = "";
		adapter.swapCursor(ModelCursor);
		adapter.notifyDataSetChanged();

		//ModelCursor.requery();
		//adapter.notifyDataSetChanged();
		//ModelListView.invalidateViews();
